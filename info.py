...
URL = "https://{https://movie-3-0-ci7h.onrender.com}/".format(FQDN) if ON_HEROKU or NO_PORT else \
    "http://{https://movie-3-0-ci7h.onrender.com}:{https://movie-3-0-ci7h.onrender.com}/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://{https://movie-3-0-ci7h.onrender.com}/".format(FQDN)
else:
    URL = "http://{https://movie-3-0-ci7h.onrender.com}/".format(FQDN)
